...
const SECTIONS = [
  { title: "Account", rows: [
    ...
    { emoji: "🔒", bg: "bg-yellow-50",  label: "KYC Verification",    sub: "Verified ✓",                  action: "kyc", subGreen: true },
  ...
  { title: "Security", rows: [
    ...
    { emoji: "☝️", bg: "bg-[#e6f7f0]", label: "Biometric Login", sub: "Fingerprint & Face ID",         action: "biometric", toggle: true },
  ]},
  { title: "Support", rows: [
    { emoji: "", bg: "bg-purple-50",  label: "Notifications",  sub: "48 unread",                     action: "notifications" },
    { emoji: "❓", bg: "bg-yellow-50",  label: "Help Center",    sub: "FAQs and support",              action: "help" },
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 bg-[#f2f3f5] rounded-t-3xl -mt-5 overflow-y-auto px-3.5 pt-5 pb-4">
        ...
        <p className="text-center text-xs text-gray-300 mt-2">OPay v5.2.1 · © 2026 OPay Digital Services</p>
      </div>
