...
const OPTIONS = [
  ...
  { label: "USSD",                sub: "Dial *955# — No internet needed",    bg: "bg-[#f0fdf4]", stroke: "#19a46a", icon: <><rect x="5" y="2" width="14" height="20" rx="2" /><circle cx="12" cy="17" r="1" fill="#19a46a" stroke="none" /></> },
]
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 bg-white rounded-t-3xl -mt-4 px-4 pt-5 overflow-y-auto pb-6">
        <div className="bg-[#e6f7f0] rounded-2xl p-4 mb-5 border border-[#b2dfcc] text-center">
          ...
          <p className="text-sm text-[#19a46a] font-bold mb-3">OPay — {userName}</p>
          <button onClick={() => showToast("Account number copied!")} className="px-5 py-2.5 rounded-full bg-[#19a46a] text-white text-xs font-bold">🎉 Copy Account Number</button>
        </div>
