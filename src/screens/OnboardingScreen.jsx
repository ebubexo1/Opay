...
const SLIDES = [
  { emoji: "💸", title: "Fast & Secure Payments", body: "Send money, pay bills and manage your finances all in one place with OPay." },
  { emoji: "🎁", title: "Earn While You Spend",   body: "Get cashback, earn reward points and enjoy exclusive offers every time you transact." },
  { emoji: "🔐", title: "Your Money is Safe",     body: "Bank-level security with biometric login, real-time alerts and 24/7 fraud protection." },
]
