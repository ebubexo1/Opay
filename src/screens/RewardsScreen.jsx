...
const EARN_LIST = [
  { emoji: "💸", title: "Make a Transfer",      pts: "+50 pts per transfer",    action: "transfer",      btn: "Do Now" },
  { emoji: "", title: "Buy Airtime",           pts: "+20 pts per purchase",    action: "airtime",       btn: "Do Now" },
  { emoji: "💵", title: "Refer a Friend",        pts: "+500 pts per referral",   action: "copy-link",     btn: "Invite" },
  { emoji: "💰", title: "Save with OWealth",     pts: "+100 pts per ₦10K saved", action: "toast-owealth", btn: "Save"   },
  { emoji: "⚡", title: "Pay Electricity Bills", pts: "+30 pts per payment",     action: "toast-elect",   btn: "Pay Now"},
]

const REDEEM_LIST = [
  { emoji: "🎁", title: "₦500 Cashback",    pts: "500 pts required",   action: "toast-cashback" },
  { emoji: "🥇", title: "Free Data 1GB",    pts: "300 pts required",   action: "toast-data"     },
  { emoji: "🎁", title: "₦200 Airtime",     pts: "200 pts required",   action: "toast-airtime"  },
...
export default function RewardsScreen() {
  ...
  const doAction = (action) => {
    ...
    else if (action === "toast-cashback")showToast("₦500 cashback redeemed! 🎯")
    else if (action === "toast-data")    showToast("1GB data redeemed! 🎯")
    else if (action === "toast-airtime") showToast("₦200 airtime redeemed! 🎯")
