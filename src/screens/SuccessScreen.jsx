  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 overflow-y-auto py-8">
        ...
        <button onClick={() => showToast("Receipt shared!")} className="w-full py-4 rounded-2xl bg-[#e6f7f0] text-[#19a46a] font-bold text-[15px]">📤 Share Receipt</button>
      </div>
      <AndroidNav />
    </div>
  )
